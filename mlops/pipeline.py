...
@component
def compare_and_register_op(model_path: str, accuracy: float):
    from mlops.components.compare_and_register import compare_and_register_model
...
@dsl.pipeline(
    ...
    description="Continuous training with model comparison"
)
